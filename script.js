...
var addressString = "<div class='mapview'><iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31918.170692918193!2d109.05220024100608!3d0.2780578976898389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31e293441586093b%3A0x4b36e73b3f21c4f6!2sSungaipinyuh%2C%20Galang%2C%20Kec.%20Sungai%20Pinyuh%2C%20Kab.%20Mempawah%2C%20Kalimantan%20Barat!5e0!3m2!1sid!2sid!4v1751779477992!5m2!1sid!2sid' class='map'></iframe></div><label class='add'><address>4 'Sungai Pinyuh'<br>Kalimantan</address>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hi kak 👋🏻,<br><br>Selamat datang di <span class='bold'><a class='alink'>roni.my.id</a> ^_^</span><br><br>Hubungi saya di mail <span class='bold'>gusti@roni.my.id</span><br><br>Terima Kasih.<br><br>Ketik <span class='bold'>'bantuan'</span> untuk perintah<br>");
            }, 2000);
            break;
        case "bantuan":
            sendTextMessage("<span class='sk'>pilih kata kunci berikut ini kak<br>Contoh:<br><span class='bold'>'alamat'</span> - untuk mengetahui alamat saya<br><span class='bold'>'clear'</span> - untuk membersihkan isi chat ini<br><span class='bold'>'tentang'</span> - untuk mengetahui tentang saya<br><span class='bold'>'hubungi'</span> - untuk menghubungi saya</span>");
            break;
        case "alamat":
        ...
        case "clear":
            ...
            break;
        case "tentang":
            sendTextMessage("🛠️💻 Saya adalah Roni<br><br>👨🏻‍💻 ^^ <a class='alink' target='_blank' href='https://roni.my.id'><span class='bold'>roni.my.id</a> ❤️</span>");
            break;
        case "hubungi":
